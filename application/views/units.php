...
<html lang="en">
  ...
  <head><base href="../">
    ...
    <link rel="stylesheet" type="text/css" href="assets/plugins/custom/simditor/styles/simditor.css" />
  </head>
                ...
                <div class="row">
                  ...
                  <div class="card-header">
                    <div class="card-title">
                      <h3 class="card-label">All Units</h3>
...
<div class="modal fade" id="addCatModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addCatForm" method="post" action="admin/units/addUnits">
                  <div class="form-group row">
                      <div class="col-lg-6">
                      ...
                      <div class="col-lg-12">
                        ...
                        <input type="text" id="catName" name="unit" class="form-control" placeholder="Enter unit name">
                        <span id="catError" style="color: red;" class="form-text helpTextNone">Please enter unit name</span>
                      </div>
                      <div class="col-lg-6">
                        <button type="button" style="margin-top: 25px;" id="submitCategory" class="btn btn-primary mr-2">Add Unit</button>
                      </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="addTutModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="addTutForm" method="post" action="admin/units/addTutorials">
                  <div class="form-group row">
                      <div class="col-lg-12">
                        <label>Tutorial:</label>
                      </div>
                      <div class="col-lg-12">
                      <Textarea id="tut" name="tut"></Textarea>
                      </div>
                      <div class="col-lg-6">
                        <input type="hidden" id="unitId" name="unitId"/>
                        <button type="submit" style="margin-top: 25px;" id="submitTutorial" class="btn btn-primary mr-2">Add Tutorial</button>
                      </div>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="updateUnitModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="updateUnitForm" method="post" action="admin/units/updateUnits">
                  <div class="form-group row">
                      <div class="col-lg-12">
                        <label>Unit Name:</label>
                        <input type="text" id="unitName" name="unit" class="form-control" placeholder="Enter subject">
                        <span id="catError" style="color: red;" class="form-text helpTextNone">Please enter subject</span>
                      </div>
                      <div class="col-lg-6">
                          <input type="hidden" id="unitId" name="unitId"/>
                        <button type="button" style="margin-top: 25px;" id="updateUnitButton" class="btn btn-primary mr-2">Update Unit</button>
                      </div>
                    </div>
                </form>
            </div>
   ...
   <script src="assets/js/pages/crud/datatables/data-sources/ajax-server-side-units.js"></script>
   <!--<script type="text/javascript" src="assets/plugins/custom/simditor/site/assets/scripts/jquery.min.js"></script>-->
    <script type="text/javascript" src="assets/plugins/custom/simditor/site/assets/scripts/module.js"></script>
    <script type="text/javascript" src="assets/plugins/custom/simditor/site/assets/scripts/hotkeys.js"></script>
    <script type="text/javascript" src="assets/plugins/custom/simditor/site/assets/scripts/uploader.js"></script>
    <script type="text/javascript" src="assets/plugins/custom/simditor/site/assets/scripts/simditor.js"></script>
   ...
   <script type="text/javascript">
    ...
    $(document).on("click","#updateUnitButton",function(e) {
      if($.isEmptyObject($("#unitName").val())) {
    ...
    function addTutorial(unitId) {
      ...
      $("#addTutModel").modal("show");
    }
    
    function editTutorial(unitId,tut) {
      $("#unitId").val(unitId);
      Simditor.locale = 'en-US'
      var editor = new Simditor({
            textarea: $('#tut')
